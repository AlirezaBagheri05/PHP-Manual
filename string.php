...
// nl2br(); هرجا که ان باشه خط جدید ایجاد میکنه و میره خط بعد اگه خط جدید | لاین جدید نرفت از این فانکشن استفاده کن
...
// sscanf(); استرینگ چاپ میکنه ولی بصورت داینامیک و با گرفتن مقدار .... فیلد ها رو پر و رشته رو بر میگردونه ب عبارتی چاپ میکنه
...
// str_ireplace(); یک کلمه را در متن رشته استرینگ جست و جو میکنه و جای او کلمه ای که تعریف کردیم را میگذارد و تعداد جایگزین کردن ها را نیز بر میگردونه
...
// str_pad(); به اندازه مشخص و محدود مجوز چاپ کاراکتر رو میده و اگه کمتر از مقدار مشخص بود از مقداری که تریف کردیم استفاده میکه تا به تعداد کاراکتر مدنظر برسذ
...
// strchr(); از یک قسمت مشخص شده در استرینگ رشته متن شروع به برگردوندن متن میکنه.. یک کلمه رو جست و جو میکنه از اون بعدش رو برمیگردونه
